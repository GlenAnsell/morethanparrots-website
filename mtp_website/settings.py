"""
Django settings for mtp_website project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-sx@7+2($i4^m%tulw7)dpn5@wc2@y2mvx##8$$5x6g*r5+9%xf')
...
WSGI_APPLICATION = 'mtp_website.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='mtpdb'),
        'USER': config('DB_USER', default='mtpuser'),
        'PASSWORD': config('DB_PASSWORD', default='mtppass'),
